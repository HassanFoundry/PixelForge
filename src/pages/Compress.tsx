        ...
        <section aria-label="Compression settings" className="card p-5 lg:sticky lg:top-24">
          ...
          <div className="mt-4 grid gap-5">
            ...
            <QualitySlider
              ...
              note={
                qualityDisabled
                  ? 'PNG is lossless, so the quality setting does not apply.'
                  : 'Lower quality usually produces smaller files. A setting from 70 to 85% works well for many photos.'
              }
            />
        ...
        <section aria-label="File queue">
          {queue.items.length === 0 ? (
            <div className="grid gap-4">
              <Dropzone hint="JPG, PNG and WebP are recommended. You can add up to 30 files at once." onFiles={queue.addFiles} />
            </div>
          ) : (
