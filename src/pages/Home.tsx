...
const faqs = [
  {
    ...
    answer:
      'Correct. Every tool runs in your browser using Canvas and Web Worker APIs. There is no upload code in PixelForge at all — you can load the site, go offline, and keep working.'
  },
  {
    question: 'Is there a file size limit?',
    answer:
      'Only your device. Since nothing is sent to a server, limits come from your browser and available memory. Phones may struggle with images beyond roughly 40 megapixels; a laptop will handle far more.'
  },
  {
    question: 'Which formats can PixelForge read and write?',
    answer:
      'It reads JPG, PNG, WebP, GIF, BMP, SVG and AVIF (depending on your browser). It writes JPG, PNG, WebP and AVIF — the format picker only lists options your browser can actually encode.'
  },
  {
  ...
  },
  {
    question: 'Is it free?',
    answer:
      'Yes. No account, no watermark, no premium tier. Because processing happens on your device, there is no server bill to pass on to you.'
  },
  {
...
const highlights = [
  ...
  },
  {
    ...
    text: 'Three theme modes with a remembered preference, designed for both ends of the day.'
  },
  {
    icon: WifiOff,
    title: 'Works offline',
    text: 'Install it as an app or just keep the tab open — the tools keep working without a network.'
  }
]
...
const workflowSteps = [
  ...
  },
  {
    ...
    text: 'Set quality, dimensions, format or crop. What you see in the preview is what gets exported.'
  },
  {
    step: '3',
    title: 'Download',
    text: 'Save files one by one or grab a ZIP. Nothing is stored anywhere when you close the tab.'
  }
]
...
const comparisonRows: { label: string; pixelforge: string; typical: string }[] = [
  ...
  { label: 'Privacy policy for your images', pixelforge: 'Not needed', typical: 'Read the fine print' }
]
    ...
    <>
      <section className="border-b border-line">
        <div className="shell flex flex-col items-center py-16 text-center sm:py-24">
          ...
          <p className="mt-4 text-xs text-ink-faint">Free · No account · Works offline</p>
        ...
        <div className="shell py-14 sm:py-20">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-ink-soft">Ten focused tools, one promise: your files stay on your device.</p>
            </div>
          </div>
      ...
      <section className="border-b border-line">
        <div className="shell py-14 sm:py-20">
          ...
          <p className="mt-2 max-w-2xl text-ink-soft">
            Most online image tools ask you to hand your photos to a server and wait. PixelForge
        ...
        <div className="shell grid gap-10 py-14 sm:py-20 lg:grid-cols-[1.2fr_2fr]">
          <div>
            ...
            <p className="mt-2 text-ink-soft">
              Three steps, no upload bar in sight.
            </p>
          </div>
      ...
      <section className="border-b border-line">
        <div className="shell grid gap-10 py-14 sm:py-20 lg:grid-cols-[1.2fr_2fr]">
          <div>
            ...
            <p className="mt-2 text-ink-soft">
              One photo is easy. Twenty should be too.
            </p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2">
            <p className="text-sm leading-relaxed text-ink-soft">
              Drop a whole folder into the queue and PixelForge works through it file by file,
              keeping the interface responsive while each image is processed. You see the state of
              every file — waiting, working, done or failed — with real output sizes and savings.
            </p>
      ...
      <section className="border-b border-line bg-surface">
        <div className="shell py-14 sm:py-20">
          ...
          <p className="mt-2 max-w-2xl text-ink-soft">
            Everyday users, designers, developers, photographers, bloggers, students, social media
            managers and small businesses — anyone who wants image work done without an
            upload-and-wait detour.
          </p>
      ...
      <section className="border-b border-line">
        <div className="shell py-14 sm:py-20">
          <h2 className="font-display text-2xl font-semibold tracking-tight text-ink sm:text-3xl">
            PixelForge vs. upload-based tools
          </h2>
      ...
      <section>
        <div className="shell flex flex-col items-center py-16 text-center sm:py-20">
          ...
          <p className="mt-3 max-w-xl text-ink-soft">
            Pick a tool and drop in a file. No sign-up screen is going to appear.
          </p>
